...
<div class="container">
	<form action="${pageContext.request.contextPath}/auth/loginProc" method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=1bba6aafcad7c5f83d3e74b925ceb08a&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code"><img height="38px" src="${pageContext.request.contextPath}/image/kakao_login_button.png"> </a>
	</form>
<br>
</div>
